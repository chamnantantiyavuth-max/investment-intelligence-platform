# AAPL — Evidence Log (RM-2026-0001)
...
## 1. Product-mix net sales (10-K FY2025, Note 2 — Revenue disaggregation)

| ($M) | FY2025 | FY2024 | FY2023 | FY25 y/y |
|---|---|---|---|---|
| iPhone | 209,586 | 201,183 | 200,583 | +4.2% |
| Mac | 33,708 | 29,984 | 29,357 | +12.4% |
| iPad | 28,023 | 26,694 | 28,300 | +5.0% |
| Wearables, Home & Accessories | 35,686 | 37,005 | 39,845 | −3.6% |
| **Services** | **109,158** | 96,169 | 85,200 | **+13.5%** |
| **Total net sales** | **416,161** | 391,035 | 383,285 | +6.4% |

- Services share of total: FY23 22.2% → FY24 24.6% → FY25 **26.2%**
- Services GM: FY23 70.8% → FY24 73.9% → FY25 **75.4%** (Products GM 36.5/37.2/36.8%)
- Total GM: 44.1% → 46.2% → **46.9%** (MD&A Gross Margin table)
- Deferred revenue at beginning of period: 8,229 / 7,728 / 8,169; total deferred revenue $13.7B (9/27/25) vs $12.8B (9/28/24) — Services momentum indicator
- Net income: 112,010 / 93,736 / 96,995; weighted-avg basic shares 14,948,500 / 15,343,783 / 15,744,231 (K) — FY25 net margin 26.9%
- ⚠ FY24 NI includes one-time $10.2B net Ireland State Aid tax charge (Note 7) — FY24 reported NI understated vs underlying

## 2. Geographic segments (10-K FY2025, Note 13 — Segment Information; CODM = CEO)

| ($M) FY2025 | Americas | Europe | Greater China | Japan | Rest APAC | Corporate | Total |
|---|---|---|---|---|---|---|---|
| Net sales | 178,353 | 111,032 | 64,377 | 28,703 | 33,696 | — | 416,161 |
| Operating income | 72,480 | 47,739 | 26,917 | 13,955 | 14,586 | (42,627) | 133,050 |

| Operating income by segment | FY2025 | FY2024 | FY2023 |
|---|---|---|---|
| Americas | 72,480 | 67,656 | 60,508 |
| Europe | 47,739 | 41,790 | 36,098 |
| Greater China | 26,917 | 27,082 | 30,328 |
| Japan | 13,955 | 12,454 | 11,888 |
| Rest of Asia Pacific | 14,586 | 13,062 | 12,066 |
| Corporate (R&D + G&A) | (42,627) | (38,828) | (36,587) |
| **Total operating income** | **133,050** | 123,216 | 114,301 |

- Americas = 42.9% of net sales; Greater China 15.5% (down from 18.9% FY23 — mix shift)
- MD&A segment drivers FY25: Americas ↑ iPhone+Services; Europe ↑ Services/iPhone/Mac; **Greater China ↓ (lower iPhone, partially offset by Mac)**; Japan ↑ iPhone/Services/iPad; Rest APAC ↑ iPhone/Services/Mac
- **Q3 FY2026 reversal: Greater China +22.4% y/y, every geographic segment grew (8-K Q3 FY26)**
- R&D: 34,550 FY25 = 8.3% of revenue (corporate line); FY24 31,370; FY23 29,915

## 3. Supply / concentration (10-K FY2025, Notes + Item 1A)

- Most components available from multiple sources; certain components from single/small number of sources (custom components not commonly used by competitors); new products often use custom components available from only ONE source
- Substantially all hardware manufactured by outsourcing partners, primarily China mainland, India, Japan, South Korea, Taiwan, Vietnam (geographic concentration — Cost Advantage dimension)
- Manufacturing purchase obligations $56.2B as of 9/27/25 ($55.4B within 12 months)
- Distribution: direct 40% / indirect 60% of FY25 net sales (Item 1)

## 4. Services narrative (10-K FY2025, Item 1 + MD&A)

- Services lines: Advertising (third-party licensing + own platforms), AppleCare, Cloud Services (iCloud), Digital Content (App Store, Arcade, Fitness+, Music, News+, TV+), Payment Services (Apple Card, Apple Pay)
- FY25 Services growth drivers (MD&A): **advertising, App Store, cloud services**
- Services revenue recognized over time; third-party app sales accounted net basis (only commission retained); Services net sales include amortization of deferred value of services bundled with products
- Installed base: 10-K does NOT publish the count. 8-K Q3 FY26 (CFO): "installed base of active devices reached a new all-time high across all major product categories and geographic segments" — qualitative confirmation of installed-base growth, no figure in filings

## 5. Item 1A Risk Factors — moat-relevant (10-K FY2025)

- **Competition:** markets "highly competitive"; aggressive price competition, downward pressure on gross margins; competitors with broad product lines, low-priced products, large installed bases; certain competitors can price "at little or no profit or even at a loss"; **Apple has minority market share in global smartphone, PC, tablet, wearables markets**
...
| **Total revenue** | **109,417** | 94,036 | **+16.4%** |
| Gross margin | 54,770 (50.1%) | 43,718 (46.5%) | — |
| Operating income | 35,695 | 28,202 | +26.6% |
...
| Dividends paid (incl equivalents, FY25 8-K 9-mo basis) | — | — | — | — | ~15,200 est |
| Shares outstanding (period end, B) | 16.43 | 15.94 | 15.55 | 15.12 | 14.77 |

- Buybacks cumulative FY21–25 ≈ **$438.6B**; share count −10.1% FY21→FY25
- R&D: 21,914 → 26,251 → 29,915 → 31,370 → 34,550 (FY25 8.3% of revenue)
- OCF ≥ ~$104B every year; capex light (2–3% of revenue) — capital intensity low
