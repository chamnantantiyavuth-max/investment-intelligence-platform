...
**Amended 2026-08-07 (FD #80):** row 11 — **mid-week Radar Watch cron AUTHORIZED** (supplement to the FD #78 weekly scan; job `cda817d17236`, Thu 08:00 UTC+7, deliver local, lighter pass: 0–2 cards max, short mid-week watch note → `kanban/digests/YYYY-MM-DD-radar-midweek.md`; reads latest Monday digest for continuity; retries data-gapped watch items). Row content unchanged — discovery-only per FD #75. Rows 1–10 unchanged.
**Amended 2026-08-07 (FD #81):** row 11 — **EDGAR filings scan ADDED** (radar gap (b)): SEC EDGAR submissions feed is a standing scan area for the FO-universe equity watchlist (8 CIKs: AAPL/MSFT/NVDA/GOOGL/AMZN/META/TSLA/JNJ) — Monday full pass (material items: 8-K material items, 10-Q/10-K, DEF 14A, SC 13D/G, 13F-HR season, S-1/S-3/424B, Form 4 clusters, 8-K clusters) + Thursday delta check; routine scheduled filings are NOT cards; **MSFT = CIW pilot boundary — digest note only, never a card (FD #44)**. Row content otherwise unchanged. Rows 1–10 unchanged.
**Amended 2026-08-07 (FD #82):** row 11 — **feedback loop ADDED** (radar gap (c)): `kanban/card-outcomes.md` = read-only input register for all scans (owned by IC Secretary/session closeouts) — do-not-reraise (no duplicate of open Inbox cards or register-marked items), known-gap policy (KNOWN-GAP retried only on new source/season/event; ACTIVE monthly auto-retry), refine (watch areas evolve per register watchlist implications). Row content otherwise unchanged. Rows 1–10 unchanged.
