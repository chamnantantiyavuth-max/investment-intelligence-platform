...
| 11 | Radar Scout / Opportunity Monitor | `org-radar-scout` | Scanning Assistant | Opportunity discovery: continuous monitor of massive public data for anomalies/divergences/unusual signals → Task Idea Cards to research intake (FD #71 — scout/radar layer, Option B) + **bounded momentum-screen scanning mandates per approved O'Neil/Minervini Rule Pack (FD #74 — Option B, no new role; conceptual signals only, no invented thresholds FD #53)** | Task Idea Card, Radar Digest, Anomaly Log |
