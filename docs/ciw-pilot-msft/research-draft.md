...
- **What is genuinely non-consensus:** (a) "model choice" as a deliberate architecture that treats frontier models as fungible — Microsoft benefits even if OpenAI/Anthropic lose; (b) useful-life extension + lease reclassification as *accounting-optics* improvement (capex guided lower but real cash spend unchanged); (c) Copilot as a potential Office-scale platform rather than a feature; (d) the commitment stack ($743.8B) as an under-appreciated constraint on flexibility. `[SRC-003a Q&A; guidance; MD&A Contractual Obligations]`
...
9. **Accounting optics:** FY27 useful-life extension + finance→operating lease reclassification reduces *reported* capex (~$175B vs ~$190B) without changing cash economics — flagged for monitoring `[SRC-003a guidance]`.
...
| C14 | Useful-life extension 15→25 yrs datacenters, effective FY27; minimal FY27 op-income benefit; adjusts CY2026 capex to ~$175B | SRC-003a guidance |
