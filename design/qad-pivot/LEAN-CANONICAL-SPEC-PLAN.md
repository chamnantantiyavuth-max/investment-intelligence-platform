...
| 5 | **QAD-SCUTTLEBUTT-PROTOCOL.md** | QAD-MODERN-SCUTTLEBUTT.md (scuttlebutt-specific sections) | Elastic investigator spawning rules, max concurrent investigators (3 unless Research Director approves via Expected-Information-Value justification, per frozen budget authority: **Research Director → EIV justification → Research Budget Controller applies approved policy**; Chief Underwriter/Founder participate only beyond an explicitly defined exceptional threshold), Evidence Gap ID requirement, 12 investigator types with triggering conditions, falsifiable research question mandate |
