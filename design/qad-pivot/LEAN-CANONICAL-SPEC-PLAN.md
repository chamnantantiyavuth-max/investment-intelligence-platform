...
| 5 | **QAD-SCUTTLEBUTT-PROTOCOL.md** | QAD-MODERN-SCUTTLEBUTT.md (scuttlebutt-specific sections) | Elastic investigator spawning rules. **Default investigator concurrency = 3. >3 requires Research Director Expected-Information-Value justification → Research Budget Controller applies approved policy.** Research Director proposes/justifies; Research Budget Controller authorizes within policy. Chief Underwriter/Founder participate only beyond explicitly defined exceptional thresholds. Evidence Gap ID requirement, 12 investigator types with triggering conditions, falsifiable research question mandate |
