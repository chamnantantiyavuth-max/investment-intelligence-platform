...
The Constitution is the authority. These operational files translate it into working constraints for agents and future implementation.

## Core

- `operational/FOUNDERS-DECISIONS.md`
- `operational/PRODUCT-VISION.md`
...
- `operational/EVIDENCE-DOCTRINE.md`
- `operational/THEME-INTELLIGENCE.md`
...
- `operational/WORKING-HYPOTHESES.md`
