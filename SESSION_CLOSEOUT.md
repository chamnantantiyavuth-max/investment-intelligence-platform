...
3. **Deferred (unchanged):** 0012 re-test at settled macro window; UI-4, A-01, C-04/C-05/M-02. D1–D4 blog backlog: D1 + D3 CLOSED by this implementation; D2/D4 resolved by B's design (full-width layout + short wordmark).
