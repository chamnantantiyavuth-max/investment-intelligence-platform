# Radar Cards — ORG-2026-0009 Published-State Verification

**Type:** ad-hoc verification (no canonical test suite exists for kanban YAML data)
**Date:** 2026-08-07 03:10 UTC+7 · **Method:** tempfile script (`hermes-verify-` prefix, created/run/cleaned) + PyYAML round-trip
...
- board.md: 0009 Published; 0010/0011 remain Scoped (research pending — 0010 next)

Script output: `PASS — ORG-2026-0009: 28/28 fields; Published; audit='CLEAN WITH MINORS…'; board OK; 0010/0011 still Scoped`

Chain: reports published b89f365 → state sync + this evidence (card 0009 → Published). RADAR round 2: 1/3 cards published; next: 0010 Services GM verification.

<!-- 2026-08-07 03:10 UTC+7 -->
